...
def sendsms(_host, _user, _password, _db, _charset, _port, _sender, _receivers, _msg_euckr, condition, creation_time, delta_seconds):
    print (_msg_euckr)
    try:
        # Connection
    ...
    try:
        ...
        # SQL
            ...
            for _receiver in enumerate(_receivers):
